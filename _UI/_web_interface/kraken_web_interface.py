    ...
    squelch_card = \
        html.Div([
            ...
            html.Div([
                ...
                dcc.Input(id='phase_test_1', value=webInterface_inst.module_signal_processor.phasetest[0],
                          type='number', debounce=True, className="field-body")
            ], className="field"),

            html.Div([
                html.Div("Phase Test 2:", className="field-label"),
                dcc.Input(id='phase_test_2', value=webInterface_inst.module_signal_processor.phasetest[1],
                          type='number', debounce=True, className="field-body")
            ], className="field"),

            html.Div([
                html.Div("Phase Test 3:", className="field-label"),
                dcc.Input(id='phase_test_3', value=webInterface_inst.module_signal_processor.phasetest[2],
                          type='number', debounce=True, className="field-body")
            ], className="field"),

            html.Div([
                html.Div("Phase Test 4:", className="field-label"),
                dcc.Input(id='phase_test_4', value=webInterface_inst.module_signal_processor.phasetest[3],
                          type='number', debounce=True, className="field-body")
            ], className="field"),

            html.Div([
                html.Div("Phase Test 5", className="field-label"),
                dcc.Input(id='phase_test_5', value=webInterface_inst.module_signal_processor.phasetest[4],
                          type='number', debounce=True, className="field-body")
            ], className="field"),
